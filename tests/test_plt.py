...
def check_plt_entries(filename):
    ...
    if filename == os.path.join("armel", "helloworld"):
        assert ld.main_object.plt == {
            "printf": 0x102E0,
            "__libc_start_main": 0x102EC,
            "__gmon_start__": 0x102F8,
            "abort": 0x10304,
        }
        return
    ...
    if filename == os.path.join("x86_64", "true"):
        assert ld.main_object.plt == {
            ...
            u"free": 0x1450,
            u"abort": 0x1458,
            u"__errno_location": 0x1460,
            u"strncmp": 0x1468,
            u"_exit": 0x1470,
            u"__fpending": 0x1478,
            u"textdomain": 0x1480,
            u"fclose": 0x1488,
            u"bindtextdomain": 0x1490,
            u"dcgettext": 0x1498,
            u"__ctype_get_mb_cur_max": 0x14A0,
            u"strlen": 0x14A8,
            u"__stack_chk_fail": 0x14B0,
            u"mbrtowc": 0x14B8,
            u"strrchr": 0x14C0,
            u"lseek": 0x14C8,
            u"memset": 0x14D0,
            ...
            u"malloc": 0x1518,
            u"fflush": 0x1520,
            u"nl_langinfo": 0x1528,
            u"ungetc": 0x1530,
            u"__freading": 0x1538,
            u"realloc": 0x1540,
            u"fdopen": 0x1548,
            u"setlocale": 0x1550,
            u"__printf_chk": 0x1558,
            u"error": 0x1560,
            u"open": 0x1568,
            u"fseeko": 0x1570,
            u"__cxa_atexit": 0x1578,
            u"exit": 0x1580,
            u"fwrite": 0x1588,
            u"__fprintf_chk": 0x1590,
            u"mbsinit": 0x1598,
            u"iswprint": 0x15A0,
            u"__cxa_finalize": 0x15A8,
            u"__ctype_b_loc": 0x15B0,
        }
        return
    ...
    if replaced_filename not in PLT_CACHE:
        ...
        p2 = subprocess.Popen(
            ["grep", "@plt>:"], stdin=p1.stdout, stdout=subprocess.PIPE
        )
        p1.stdout.close()
    ...
    assert ideal_plt == ld.main_object.plt
...
if __name__ == "__main__":
    ...
    pickle.dump(
        PLT_CACHE,
        open(os.path.join(TESTS_BASE, "tests_data", "objdump-grep-plt.p"), "wb"),
    )
